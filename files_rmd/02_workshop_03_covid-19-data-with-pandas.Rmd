...
asean_df_latest['Deaths'].plot(kind = 'barh').set_xlabel('Total Deaths')
...
1. Find the daily cases for each country using `pd.diff()`.

2. Plot the daily number of confirmed cases against dates.

3. Ensure that each country has their own `colour`.
